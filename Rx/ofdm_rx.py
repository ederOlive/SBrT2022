...
# Title: OFDM_Rx_LRC
# Author: Eder Oliveira de Souza
# Description: OFDM Rx with LRC and without CRC-32
# Generated: Sun Aug 14 17:35:40 2022
##################################################
...
from low_resolution_converter import low_resolution_converter  # grc-generated hier_block
...
class ofdm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "OFDM_Rx_LRC")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM_Rx_LRC")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = int(1.8e6)
        ...
        self.ntaps = ntaps = 24
        self.length_tag_key = length_tag_key = "packet_tag"
        ...
        self.osmosdr_source_0.set_gain(7.7, 0)
        self.osmosdr_source_0.set_if_gain(20, 0)
        self.osmosdr_source_0.set_bb_gain(20, 0)
        self.osmosdr_source_0.set_antenna('', 0)
        self.osmosdr_source_0.set_bandwidth(0, 0)

        self.low_resolution_converter_0 = low_resolution_converter(
            alpha=alpha,
            nbits=nbits,
            nsamples=nsamples,
            ntaps=ntaps,
        ...
        self.blocks_file_sink_1_1_0 = blocks.file_sink(gr.sizeof_char*1, '/dev/pts/1', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_file_sink_1_1_0, 0))
        ...
        self.connect((self.low_resolution_converter_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.osmosdr_source_0, 0), (self.low_resolution_converter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_sym_rate(2*self.samp_rate)
        self.osmosdr_source_0.set_sample_rate(self.samp_rate)
        self.low_resolution_converter_0.set_samp_rate(self.samp_rate)
    ...
    def set_ntaps(self, ntaps):
        self.ntaps = ntaps
        self.set_nsamples(int(self.ntaps/2))
        self.low_resolution_converter_0.set_ntaps(self.ntaps)
    ...
    def set_sym_rate(self, sym_rate):
        ...
        self.low_resolution_converter_0.set_sym_rate(self.sym_rate)
    ...
    def set_nsamples(self, nsamples):
        ...
        self.low_resolution_converter_0.set_nsamples(self.nsamples)
    ...
    def set_nbits(self, nbits):
        self.nbits = nbits
        self.low_resolution_converter_0.set_nbits(self.nbits)
    ...
    def set_alpha(self, alpha):
        self.alpha = alpha
        self.low_resolution_converter_0.set_alpha(self.alpha)
